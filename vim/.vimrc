...
vmap <leader>nc <Plug>NERDCommenterToggle<CR>gv
...
nmap <silent> <C-t> :call fzf#run({'sink':'tabe','down':'30%'})<CR>
nmap <C-p> :GFiles<CR>
...
let g:closetag_xhtml_filetypes = 'xhtml,javascript.jsx,jsx,javascriptreact,typescript.tsx,tsx,typescriptreact'
...
" Selected lines movement
vnoremap J :m '>+1<CR>gv=gv
vnoremap K :m '<-2<CR>gv=gv

" Line skip in insert mode
" inoremap oo <C-o>o
